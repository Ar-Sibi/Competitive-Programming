...
int main(){
  ...
  //   cout<<"\n";
  // }
  sort(libextd.begin(),libextd.end(),f1d);
  // reverse(libextd.begin(),libextd.end());
  fur(i,0,libextd.size()){
    ll t=libextd[i][0];
    libextd[i][0]=libextd[i][5];
    libextd[i][5]=t;
  }
  vvll answer(l);
